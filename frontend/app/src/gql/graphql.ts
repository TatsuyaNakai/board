...
export type LoginAdminQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type LoginAdminQueryQuery = { __typename?: 'Query', loginAdmin?: { __typename?: 'Admin', id: string, accessToken: string } | null };
